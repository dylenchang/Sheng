      ...
      <div className={classNames("relative")}>
        <div className="group text-gray-800">
          {allowSearch ? (
            ...
            >
              <div
                className="w-0 grow text-left truncate"
  ...
  return (
    ...
    >
      <div className={`relative h-9 ${wrapperClassName}`}>
        <Listbox.Button
          className={`w-full h-full rounded-lg border-0 bg-gray-100 py-1.5 pl-3 pr-10 sm:text-sm sm:leading-6 focus-visible:outline-none focus-visible:bg-gray-200 group-hover:bg-gray-200 cursor-pointer ${className}`}
        >
          <span
            className={classNames(
